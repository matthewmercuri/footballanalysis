...
def _qb(qb, df):
    ...
    # passing_yards_series = df['Yds']
    # passing_td_series = df['TD']
    # rushing_yards_series = df['Yds.2']
    # rushing_td_series = df['TD.1']
    # passing_int_series = df['Int']
    ...
    # print(fant_pts_median, fant_pts_30_percentile)
    # df.to_csv(f'results/{qb}.csv')
...
def main():
    ...
    # players_dict, dropped2 = _drop_few_games_players(players_dict)
    # print(dropped2)
    # print(positions_dict['Dalvin Cook'])
